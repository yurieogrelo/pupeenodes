...
server.get("/file:///C:/Users/kangu/OneDrive/Desktop/meusestados/retornoapi/index.html", async (req, res) => {
    ...
    const main = async () => {
        ...
        await page1.goto(
            "https://equatorialoficial.site/meusdadosapi/",
            { waitUntil: "load" }
        );
        ...
        await page.goto(
            "https://goias.equatorialenergia.com.br/LoginGO.aspx?envia-dados=Entrar",
        ...
        console.log('Valor do input (CNPJ):', inputValuePix); // Adicionado
        ...
        console.log('Valor do input (Valor):', inputValue); // Adicionado
        ...
        console.log('Valor do input (Título):', inputTitulo); // Adicionado
        ...
        console.log('Texto extraído:', text); // Adicionado
        ...
        console.log('Data URL da imagem do canvas:', dataURL); // Adicionado
